	...
	<div class="container shadow-lg p-3 mb-5 bg-white rounded border" id="div-save-content">
		...
		<form:form method="post" modelAttribute="saveContent" class="contentSave">
			...
			<nav id="editorNav" class="navbar navbar-expand-lg navbar-dark bg-black pt-2">
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedTextButtons">
					<span class="navbar-toggler-icon"></span>
				</button>
                ...
                <li class="nav item">
					<div class="row">
				<label class="col-mid-2 col-form-label pl-3 text-secondary" for="titleInput">Title:</label>
				<div class="cold-mid-6 ml-3">
			<form:input path="contentTitle" class="form-control  bg-dark text-white border-secondary" id="titleInput" type="text" placeholder="Title"/>	
		</div>
		</li>
		<li class="nav item">	
			<input type="submit" value="Submit Changes" class="btn btn btn-outline-secondary ml-5" name="submit" />	
		</li>
		<li class="nav item">
		...
		<li class="nav item">
			<input id="search" name="search" class="form-control ml-5 bg-dark text-white border-secondary" type="search" placeholder="Send a pull request to" />
		</li>
	</ul>
		</form>
	</div>
